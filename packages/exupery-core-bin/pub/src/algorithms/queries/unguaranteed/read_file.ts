...
import { Signature } from "exupery-resources/dist/interface/algorithms/queries/unguaranteed/read_file"


export const $$: _et.Unguaranteed_Query_Primed_With_Resources<d.Parameters, d.Result, d.Error> = (
    $p
) => {
