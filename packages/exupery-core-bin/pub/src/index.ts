...
export type Run_Safe_Procedure_Main = (
 ...
 */
export const run_guaranteed_procedure = (
    main: Run_Safe_Procedure_Main
): void => {
    main(
...
export type Run_Unguaranteed_Procedure_Main = (
 ...
 */
export const run_unguaranteed_procedure = (
    main: Run_Unguaranteed_Procedure_Main
): void => {
    main(
